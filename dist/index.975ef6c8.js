...
var _fetchFoto = require("./fetchFoto");
var _fetchFotoDefault = parcelHelpers.interopDefault(_fetchFoto);
...
const photoApiService = new (0, _fetchFotoDefault.default);
...
},{"./fetchFoto":"bGDuZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bGDuZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class PhotoApiService {
    ...
    async fetchPhoto() {
        try {
            const response = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?key=37013770-4fd46202a1ea52ee31e31a9bd&q=${this.searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=${this.perPage}`);
            const { hits , totalHits  } = response.data;
            if (hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
            if (this.page >= totalHits / this.perPage) {
                ...
                loadMoreBtn.classList.add("is-hidden");
            } else (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${totalHits} images.`);
            this.page += 1;
            return {
                hits,
                totalHits
...
exports.default = PhotoApiService;

},{"notiflix":"5z0Oc","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
